#ifndef SHIKILKM_COMMON_H
#define SHIKILKM_COMMON_H
...
//Before you change that you need to go and check all usages of SK_MODULE_TARGET_VER
#if SK_MODULE_TARGET_VER != 6 && SK_MODULE_TARGET_VER != 7
#error "The SK_MODULE_TARGET_VER value is invalid"
#endif

#endif //SHIKILKM_COMMON_H
