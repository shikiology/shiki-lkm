 ...
 */
#ifndef SHIKI_SYNOBIOS_COMPAT_H
#define SHIKI_SYNOBIOS_COMPAT_H
...
#elif SK_MODULE_TARGET_VER == 7 //moved VTK_SET_SAFE_REMOVE_LED and VTK_GET_SYS_CURRENT below HWMON_ stuff (sic!)
...
#endif //SK_MODULE_TARGET_VER

#define VTK_GET_HDD_IFACE       51

#define VTK_SIZE 52

#endif //SHIKI_SYNOBIOS_COMPAT_H