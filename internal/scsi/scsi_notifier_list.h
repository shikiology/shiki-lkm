 ...
 */
#ifndef SHIKI_SCSI_NOTIFIER_LIST_H
#define SHIKI_SCSI_NOTIFIER_LIST_H

extern struct blocking_notifier_head sk_scsi_notify_list;

#endif //SHIKI_SCSI_NOTIFIER_LIST_H
