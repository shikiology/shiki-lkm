#ifndef SHIKI_PLATFORM_TYPES_H
#define SHIKI_PLATFORM_TYPES_H

#include "vpci_types.h" //vpci_device_stub, MAX_VPCI_DEVS

#ifndef SK_MODULE_TARGET_VER
#error "The SK_MODULE_TARGET_VER is not defined - it is required to properly set VTKs"
#endif

//All HWMON_SYS enums defined here are for internal SK use only. Normally these have long names but duplicating names
...
#if SK_MODULE_TARGET_VER == 6
    HWMON_PSU_TEMP_ID,
#elif SK_MODULE_TARGET_VER == 7
    HWMON_PSU_TEMP1_ID,
    HWMON_PSU_TEMP2_ID,
    HWMON_PSU_TEMP3_ID,
    HWMON_PSU_FAN_VOLT,
...
#else
#error "Unknown SK_MODULE_TARGET_VER version specified"
#endif
