#ifndef SHIKI_CMDLINE_OPTS_H
#define SHIKI_CMDLINE_OPTS_H
...
#define CMDLINE_KT_ELEVATOR  "elevator=" //Sets I/O scheduler (we use it to load SK LKM earlier than normally possible)
...
//0|1 - whether to use native SATA Disk-on-Module for boot drive (syno); 2 - use fake/emulated SATA DOM (sk)
